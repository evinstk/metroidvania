...
<tileset version="1.4" tiledversion="1.4.2" name="terrain8" tilewidth="8" tileheight="8" tilecount="1024" columns="32">
 <image source="../Textures/terrain8.png" width="256" height="256"/>
 <terraintypes>
  <terrain name="dirt" tile="0"/>
  <terrain name="grass" tile="0"/>
  <terrain name="floor" tile="0"/>
  <terrain name="wall" tile="0"/>
  <terrain name="window" tile="0"/>
 </terraintypes>
 <tile id="1" terrain=",,,0"/>
 ...
 <tile id="198" terrain="3,3,3,"/>
 <tile id="199" terrain="3,3,,3"/>
